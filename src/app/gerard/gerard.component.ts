...
import { Empresa, listEmpresas } from '../../empresa';

@Component({
  selector: 'app-gerard',
  standalone: true,
  imports: [Empresa],
  templateUrl: './gerard.component.html',
  styleUrl: './gerard.component.css'
})
export class GerardComponent {
...
public mostrarProyectosEnModal(empresa) {
